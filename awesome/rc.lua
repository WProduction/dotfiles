...
awful.rules.rules = {
    ...
    { rule = {class="Chromium"},properties = {floating = false, maximized = false}},
    { rule = {class="Code"},properties = {floating = false, maximized = false}},
    { rule = {class="Firefox-esr"},properties = {floating = false, maximized = false}},
}
-- }}}
